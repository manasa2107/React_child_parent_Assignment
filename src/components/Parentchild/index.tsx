    ...
    return (
        <><Typography variant="body1" gutterBottom sx={{ textAlign: 'center', mt: 10, mb:5 }}> 3. The amount in the payments card must be changed while sliding the slider. </Typography><>
            ...
            <Box
                ...
                <Typography1 typoVariant={"body2"} typoName={'You are buying'} typoSx={{color:"GrayText",textAlign:'center',fontWeight:"bold"}}/>
                <Typography1 typoVariant={"h6"} typoName={"0.0234510 BTC"} typoSx={{textAlign:'center',paddingTop:1}}/>
                <Typography1 typoVariant={"body2"} typoName={'1BTC = $3,406,069.54'} typoSx={{color:"GrayText",textAlign:'center',paddingTop:1,fontWeight:"bold",marginBottom:2}}/>

                <Divider style={{width:670,marginBottom:20}}/>
                <AvatarText1 typo1Name={'Payment method'} typo2Name={'Visa Credit ...8845'}/>
                <DividerTag />
                ...
                <Textdivider1 typo1Name={'0.0234510 BTC'} typo1Sx={{ paddingLeft:3,paddingTop:2,fontSize:"small",color:"GrayText" }} 
                typo2Name={'$34,000.00'} typo2Sx={{paddingLeft:1,paddingTop:2,fontSize:"small",color:"GrayText"}}
                 divSx={{borderStyle:'dashed',width:450,marginBottom:1,marginLeft:1}} />

                <Textdivider1 typo1Name={'transaction fee'} typo1Sx={{ paddingLeft:3,paddingTop:1,fontSize:"small",color:"GrayText" }} 
                typo2Name={'$1,000.00'} typo2Sx={{paddingLeft:1,paddingTop:2,fontSize:"small",color:"GrayText"}}
                 divSx={{borderStyle:'dashed',width:460,marginBottom:1,marginLeft:1}} />

                <Textdivider1 typo1Name={'Total'} typo1Sx={{paddingLeft:3,paddingTop:1,fontWeight:"bold"}} typo2Name={'$35,000.00'} 
